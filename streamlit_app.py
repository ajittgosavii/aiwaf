...
try:
    ...
    MODULE_ERRORS['Security & Compliance'] = str(e)
...
try:
    ...
    MODULE_STATUS['Resource Inventory'] = True
except Exception as e:
    MODULE_STATUS['Resource Inventory'] = False
    MODULE_ERRORS['Resource Inventory'] = str(e)
...
def render_main_content():
    ...
    with tabs[5]:
        if MODULE_STATUS.get('Security & Compliance'):
            try:
                SecurityComplianceModule.render()
            except Exception as e:
